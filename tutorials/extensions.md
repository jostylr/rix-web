...
Language maintainers can use the system loader to register keywords, system functions, and custom operators. Pure RiX users receive only the configured surface.
...
Study the parser and three-tier system documentation before adding syntax or capabilities.
