...
function termsEqual(left, right) {
  ...
  for (const [key, term] of a) {
    ...
    if (!other || !term.coefficient.equals(other.coefficient))
      return false;
  }
  return true;
}
...
var tutorials = [
  ...
  { number: "8f", parent: "8", file: "capstone-measurement.html", title: "Capstone: exact measurement", description: "Combine physical dimensions with an exact symbolic magnitude." },
...
//# debugId=2E6B4570393B3E2C64756E2164756E21
//# sourceMappingURL=chunk-p0x33cwk.js.map
