...
.Plugin.Load("numerics"); .numerics[:Pow, :Sqrt, :Cbrt, :NthRoot, :Hypot, :Exp, :Expm1, :Log, :Log1p, :Ln, :Log2, :Log10, :Pi, :EulerGamma, :Sin, :Cos, :Tan, :Sec, :Csc, :Cot, :Sinc, :Asin, :Acos, :Atan, :Atan2, :Sinh, :Cosh, :Tanh, :Sech, :Csch, :Coth, :Asinh, :Acosh, :Atanh, :Radians, :Degrees, :Gamma, :LogGamma, :Beta, :LogBeta, :Digamma, :Trigamma, :Erf, :Erfc, :LambertW, :Zeta, :Refine];
.Plugin.Load("bessel");
...
.Plugin.Load("solve");
.Plugin.Load("stats"); .stats[:Count, :Mean, :Quantile, :Median, :Variance, :SampleVariance, :NormalPDF, :NormalCDF, :NormalQuantile];
...
var install20 = installBrowserApproxMathPlugin;

// src/generated/bundled-plugin-catalog.js
function createBundledPluginCatalog() {
  const catalog = new PluginCatalog;
  catalog.addMetadata({ id: "algebra", description: "Exact Polynomial and RationalFunction algorithms with checked presentations.", kind: "rix", mount: "algebra", exports: ["Polynomial", "RationalFunction", "CoefficientDomain", "Coefficients", "Record", "Evaluate", "Equal", "Divide", "SyntheticDivide", "Quotient", "Remainder", "IsFactor", "Gcd", "Lcm", "SquareFreeDecomposition", "RationalRoots", "FactorEvidence", "CenteredExpansion", "Factorization", "Together", "Factored", "PartialFractions", "PoleZeroEvidence", "Expand", "Resultant", "SignAt", "SignEvidence", "RootCount", "RootCountEvidence", "Grid"], groups: ["Algebra", "Exact"], permissions: [], requires: ["rix.polynomial.algorithms@1", "rix.rational-function@1"], provides: ["rix.algebra.division@1", "rix.algebra.centered-expansion@1", "rix.algebra.factorization@1"], schemas: ["rix.algebra.division@1", "rix.algebra.centered-expansion@1", "rix.algebra.factorization@1", "rix.algebra.transformation@1", "rix.polynomial.division@1", "rix.polynomial.square-free@1", "rix.polynomial.factor-evidence@1", "rix.rational-function.together@1", "rix.rational-function.factored@1", "rix.rational-function.partial-fractions@1", "rix.rational-function.divisor-evidence@1", "rix.exact.sign-witness@1", "rix.exact.root-count@1"], snapshot: false, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:algebra" }, { source: `/**
id: algebra
...
`, sourcePath: "bundled:algebra", kind: "rix" });
  catalog.addMetadata({ id: "algebraic-real", description: "Exact real algebraic roots certified by canonical Polynomial values and Sturm isolating intervals.", kind: "rix", mount: "algebraicReal", aliases: ["ar"], exports: ["Root", "Sqrt2", "Polynomial", "Evaluate", "Derivative", "SturmSequence", "RootCount", "RootCountEvidence", "IsSquareFree", "Refine", "Sign", "SignEvidence", "CompareRational", "Export", "Import"], groups: ["Numerics", "Exact", "Algebra"], permissions: [], requires: ["rix.polynomial.algorithms@1", "rix.oracle@1"], provides: ["rix.algebraic-real@1", "rix.exact-sign@1", "rix.root-count@1", "rix.refinable@1", "rix.enclosable-real@1"], schemas: ["rix.algebraic-real@1", "rix.algebraic-real.export@1", "rix.algebraic-real.arithmetic-real@1", "rix.polynomial@1", "rix.exact.sign-witness@1", "rix.exact.root-count@1"], snapshot: false, deterministic: true, defaultEnabled: false, operatorDefinitions: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:algebraic-real" }, { source: `/**
id: algebraic-real
...
`, sourcePath: "bundled:ball", kind: "rix" });
  catalog.addMetadata({ id: "bessel", description: "Clearly named Bessel-function namespace backed by certified universal Numerics algorithms.", kind: "rix", mount: "bessel", exports: ["J", "J0", "J1", "Y", "Y0", "Y1", "I", "I0", "I1", "K", "K0", "K1"], groups: ["Numerics", "SpecialFunctions"], permissions: [], requires: ["rix.numerics@1"], provides: ["rix.bessel@1"], schemas: ["rix.numerics.algorithm-real@1"], snapshot: false, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:bessel" }, { source: `/**
id: bessel
...
`, sourcePath: "bundled:continued-fraction", kind: "rix" });
  ...
  catalog.registerInstaller("csv", install17);
...
`, sourcePath: "bundled:exact-algebras", kind: "rix" });
  ...
  catalog.registerInstaller("example-array-js", install19);
...
`, sourcePath: "bundled:example-array-rix", kind: "rix" });
  ...
  catalog.registerInstaller("float", install20);
...
`, sourcePath: "bundled:fraction", kind: "rix" });
  catalog.addMetadata({ id: "geometry", description: "Pure-RiX exact geometry, transformations, conics, constraints, and bounded portable Graphics refinement.", kind: "rix", mount: "geometry", exports: ["Point", "Line", "Segment", "Ray", "Polygon", "Circle", "Conic", "Ellipse", "Parabola", "Hyperbola", "Locus", "Implicit", "Affine", "Projective", "Transform", "Constraint", "Constraints", "Midpoint", "PerpendicularBisector", "Circumcircle", "Intersect", "Points", "Status", "Refine", "Draw"], groups: ["Geometry", "Graphics", "Exact"], permissions: [], requires: ["rix.numerics@1", "rix.polynomial.algorithms@1"], provides: ["rix.geometry@1", "rix.geometry.intersection@1", "rix.geometry.constraint@1", "rix.geometry.refinement@1"], schemas: ["rix.geometry@1", "rix.geometry.intersection@1", "rix.geometry.constraint@1", "rix.geometry.refinement@1"], snapshot: true, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:geometry" }, { source: `/**
id: geometry
...
`, sourcePath: "bundled:geometry", kind: "rix" });
  ...
  catalog.registerInstaller("gif", install18);
...
`, sourcePath: "bundled:plot", kind: "rix" });
  catalog.addMetadata({ id: "png", description: "PNG renderer for Graphics and projected Scene3D snapshots through a host rasterizer.", kind: "host", mount: "png", exports: ["Render"], groups: ["Renderers"], permissions: ["process"], provides: ["rix.renderer.png@1"], targets: ["png", "image/png"], snapshot: true, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], requires: [], optional: [], schemas: [], operatorFiles: [], ignore: false, sourcePath: "bundled:png" }, { sourcePath: "bundled:png", kind: "host" });
  catalog.registerInstaller("png", install14);
  catalog.addMetadata({ id: "poly", description: "Semantic callable univariate polynomials with structural and symbolic entry forms.", kind: "rix", mount: "poly", aliases: ["polynomial", "p"], exports: ["Polynomial", "Parse", "Var", "Fun", "Divide", "SyntheticDivide", "Gcd", "Lcm", "SquareFreeDecomposition", "RationalRoots", "FactorEvidence", "Resultant", "SignAt", "SignEvidence", "SturmSequence", "RootCount", "RootCountEvidence"], groups: ["Algebra", "Exact", "Symbolic"], permissions: [], provides: ["rix.polynomial@1", "rix.polynomial.algorithms@1", "rix.exact-sign@1", "rix.root-count@1"], schemas: ["rix.polynomial@1", "rix.polynomial.division@1", "rix.polynomial.square-free@1", "rix.polynomial.factor-evidence@1", "rix.exact.sign-witness@1", "rix.exact.root-count@1"], snapshot: false, deterministic: true, defaultEnabled: false, operatorDefinitions: [], requires: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:poly" }, { source: `/**
id: poly
...
`, sourcePath: "bundled:radix", kind: "rix" });
  catalog.addMetadata({ id: "ratfun", description: "Canonical callable univariate rational functions with exact cancellation and Polynomial interoperability.", kind: "rix", mount: "ratfun", aliases: ["rationalFunction", "rf"], exports: ["RationalFunction", "Parse", "Var", "Fun", "CoefficientDomain", "Together", "Factored", "PartialFractions", "PoleZeroEvidence", "Expand"], groups: ["Algebra", "Exact", "Symbolic"], permissions: [], requires: ["rix.polynomial@1"], provides: ["rix.rational-function@1", "rix.rational-function.presentation@1", "rix.rational-function.divisor-evidence@1"], schemas: ["rix.rational-function@1", "rix.coefficient-domain@1", "rix.algebra.transformation@1", "rix.rational-function.polynomial-factor@1", "rix.rational-function.together@1", "rix.rational-function.factored@1", "rix.rational-function.partial-fractions@1", "rix.rational-function.divisor-evidence@1"], snapshot: false, deterministic: true, defaultEnabled: false, operatorDefinitions: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:ratfun" }, { source: `/**
id: ratfun
...
`, sourcePath: "bundled:solve", kind: "rix" });
  catalog.addMetadata({ id: "stats", description: "Exact descriptive statistics plus certified normal-distribution functions and portable plots.", kind: "rix", mount: "stats", aliases: ["statistics"], exports: ["Count", "Mean", "Quantile", "Median", "Variance", "SampleVariance", "NormalPDF", "NormalCDF", "NormalQuantile", "Summary", "SummaryTable", "Histogram", "HistogramGraphic", "BoxPlot"], groups: ["Statistics", "Exact", "Graphics"], permissions: [], requires: ["rix.numerics@1"], provides: ["rix.statistics@1"], schemas: ["rix.stats.summary@1", "rix.stats.histogram@1"], snapshot: true, deterministic: true, defaultEnabled: false, operatorDefinitions: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:stats" }, { source: `/**
id: stats
...
`, sourcePath: "bundled:stern-brocot", kind: "rix" });
  catalog.addMetadata({ id: "svg", description: "Portable SVG renderer with outward-safe exact and certified coordinate lowering.", kind: "host", mount: "svg", exports: ["Render"], groups: ["Renderers"], permissions: [], provides: ["rix.renderer.svg@1", "rix.svg.coordinate-lowering@1"], schemas: ["rix.svg.coordinate-lowering@1"], targets: ["svg", "image/svg+xml"], snapshot: true, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], requires: [], optional: [], operatorFiles: [], ignore: false, sourcePath: "bundled:svg" }, { sourcePath: "bundled:svg", kind: "host" });
  catalog.registerInstaller("svg", install6);
  catalog.addMetadata({ id: "symbolic", description: "Meta-plugin joining representation-sensitive FractionFunction work with portable abstract Calculus expressions.", kind: "rix", mount: "symbolic", exports: ["Fraction", "FractionFunction", "CalculusExpression", "Evaluate", "EvaluateResult", "Differentiate", "DifferentiateResult", "DifferentiateN", "DifferentiateNResult", "Partial", "PartialResult", "Gradient", "GradientResult", "Jacobian", "JacobianResult", "Hessian", "HessianResult", "SelectedPrimitive", "AntiderivativeFamily", "DefiniteIntegral", "Obligations", "Services"], groups: ["Algebra", "Calculus", "Analysis", "Exact", "Symbolic"], permissions: [], requires: ["rix.fraction-function@1", "rix.calculus@1"], provides: ["rix.symbolic.formal@1"], schemas: [], snapshot: false, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], optional: [], targets: [], operatorFiles: [], ignore: false, sourcePath: "bundled:symbolic" }, { source: `/**
id: symbolic
...
`, sourcePath: "bundled:symbolic", kind: "rix" });
  ...
  catalog.addMetadata({ id: "webgl", description: "Browser-safe executable WebGL plans for retained Scene3D values.", kind: "host", mount: "webgl", exports: ["Render"], groups: ["Renderers", "Scene3D"], permissions: [], requires: ["rix.scene3d@1"], provides: ["rix.renderer.webgl@1", "rix.webgl-plan@1"], schemas: ["rix.webgl-plan@1"], targets: ["webgl", "application/vnd.rix.webgl+json"], snapshot: true, deterministic: true, defaultEnabled: false, operatorDefinitions: [], aliases: [], optional: [], operatorFiles: [], ignore: false, sourcePath: "bundled:webgl" }, { sourcePath: "bundled:webgl", kind: "host" });
  catalog.registerInstaller("webgl", install8);
  return catalog;
}
...
//# debugId=8B20D743685580C164756E2164756E21
//# sourceMappingURL=chunk-7pqkaxhc.js.map
